...
public class BussenGenerator {

    private Map<Integer,ArrayList<Bus>> busStart;
    private List<Bus> actieveBussen;

    public BussenGenerator(){
        this.busStart = new HashMap<>();
        this.actieveBussen = new ArrayList<>();
    }

    public void initBussen(){
    ...
    public Map<Integer, ArrayList<Bus>> getBusStart() {
        return busStart;
    }

    public List<Bus> getActieveBussen() {
